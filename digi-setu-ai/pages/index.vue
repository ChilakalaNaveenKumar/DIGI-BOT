...
// SEO
useHead({
  title: 'Digi Setu AI - Transform Learning Into Experience',
  meta: [
    { name: 'description', content: 'The AI that turns static content into interactive educational journeys. Sign in to get started.' }
  ]
})
