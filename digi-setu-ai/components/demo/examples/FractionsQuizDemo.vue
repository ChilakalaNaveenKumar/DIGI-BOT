  ...
  <div class="demo-conversation">
    <div class="demo-message user-message">
      ...
      <div class="message-content">
        Can you add some practice problems for fractions?
      </div>
    </div>
    ...
    <div class="demo-message ai-message">
      ...
      <div class="message-content">
        Of course! Here are interactive practice problems with instant feedback:

        <div class="demo-widget quiz-widget">
          <div class="widget-header">
            <Icon name="lucide:target" class="widget-icon" />
            <span class="widget-title">Fraction Practice</span>
          </div>
          <div class="quiz-question">
            <p class="question-text">Which fraction represents the largest part?</p>
            <div class="quiz-options">
              <div class="quiz-option" data-correct="false">
                <span class="option-letter">A</span>
                <span class="option-text">1/4</span>
              </div>
