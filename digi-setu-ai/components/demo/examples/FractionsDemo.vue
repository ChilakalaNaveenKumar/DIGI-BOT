  ...
  <div class="demo-conversation">
    <div class="demo-message user-message">
      ...
      <div class="message-content">
        Help me create an interactive math lesson about fractions for 4th graders.
      </div>
    </div>
    ...
    <div class="demo-message ai-message">
      ...
      <div class="message-content">
        Great! I'll create visual and interactive elements to make fractions fun and easy to understand:
        
        <div class="demo-widget">
          <div class="widget-header">
            <Icon name="lucide:calculator" class="widget-icon" />
            <span class="widget-title">Understanding Fractions</span>
          </div>
          <div class="interactive-diagram">
            <div class="process-step active" data-step="1">
              <div class="step-dot"></div>
              <span>What is a Fraction?</span>
            </div>
          ...
          <div class="widget-stats">
            ...
            <div class="stat">
              ...
              <span class="stat-label">Fun Rating</span>
            </div>
          </div>
        </div>
      </div>
